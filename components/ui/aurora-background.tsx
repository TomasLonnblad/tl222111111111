...
export const AuroraBackground = ({
  ...
  return (
    <main>
      <div
        className={cn(
          "transition-bg relative flex h-[100vh] flex-col items-center justify-center bg-zinc-150 text-slate-950 dark:bg-zinc-900",
          className,
        )}
        {...props}
      >
